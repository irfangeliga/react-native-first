...
import AddIcon from '../../assets/image/svg/add.svg';
import ExpandIcon from '../../assets/image/svg/arrowdown.svg';
...
const SecondComponent = () => {
  return (
    <View style={tw`my-5`}>
      <Text>kjsalodjaskldnasbdisad njasxb</Text>
      <HeadView />
      <Profile />
      <Description />
      <BtnAct />
...
const HeadView = () => {
  return (
    <View style={Style2.headView}>
      <View style={Style2.view2}>
        <Text style={Style2.headViewText}>cacing.cacik</Text>
        <ExpandIcon style={Style2.headViewIcon} />
      </View>
      <View style={Style2.view3}>
        <AddIcon style={Style2.plusIcon} />
        <MenuIcon style={Style2.headViewIcon} />
      </View>
    </View>
  );
};
